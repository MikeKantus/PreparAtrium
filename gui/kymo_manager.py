...
class KymoManager:
    def __init__(self, file_paths, pixel_size):
    ...
    def add_line_entry(self, tipo, slope, intercept, r, t0, t1, ax_line, ax_len_line):
        ...
        entry = {
            ...
            "x0": x0,
            "x1": x1,
            "kymo": os.path.basename(self.file_paths[self.current_index]),
            "ax_line": ax_line,
    ...
    def update_pinned_list(self):
        ...
        scroll = self.slider_pinned_scroll.val
        offset = (1 - scroll) * max(0, len(self.pinned_values) * 0.06 - 0.95)
        y = 0.95 - offset
