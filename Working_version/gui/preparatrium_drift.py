...
from PySide6.QtWidgets import (
    ...
    QFileDialog, QHBoxLayout, QSlider, QProgressBar, QGridLayout, QDialog
)
...
class MainWindow(QWidget):
    ...
    def update_original_frame(self, idx):
        ...
        self.label_original.setPixmap(pix.scaled(400, 400, Qt.KeepAspectRatio))
    ...
    def update_initial_ecc_frame(self, idx):
        ...
        qimg = numpy_to_qimage(frame)
        pix = QPixmap.fromImage(qimg)
        self.label_initial_ecc.setPixmap(pix.scaled(400, 400, Qt.KeepAspectRatio))
    ...
    def finish_optical_flow(self, aligned, masks, drifts):
        ...
        qimg = numpy_to_qimage(frame)
        pix = QPixmap.fromImage(qimg)
        self.label_drift.setPixmap(pix.scaled(400, 400, Qt.KeepAspectRatio))
    ...
    def update_optical_flow_frame(self, idx):
        ...
        qimg = numpy_to_qimage(display.astype(np.uint8))
        pix = QPixmap.fromImage(qimg)
        self.label_drift.setPixmap(pix.scaled(400, 400, Qt.KeepAspectRatio))
    ...
    def update_fine_ecc_frame(self, idx):
        ...
        pix = QPixmap.fromImage(qimg)
        self.label_fine_ecc.setPixmap(pix.scaled(400, 400, Qt.KeepAspectRatio))
